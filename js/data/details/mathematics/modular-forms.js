registerDetail({
  ...
  topics: [
    ...
    "Fundamental domains",
    "Modular forms & cusp forms",
    "Eisenstein series",
    "The valence (k/12) formula",
    "Dimensions of spaces of modular forms",
    "The j-invariant & modular functions",
    "Hecke operators",
    "Hecke eigenforms & multiplicativity",
    "L-functions of modular forms",
    "Theta functions & sums of squares",
    "Congruence subgroups",
    "The Petersson inner product",
  ],
  recommended: [
    res("Modular Functions and Modular Forms", "J.S. Milne", { type: "notes", free: true, url: "https://www.jmilne.org/math/CourseNotes/MF.pdf" }),
    res("A First Course in Modular Forms", "Diamond & Shurman", { type: "textbook" }),
  ],
  supplementary: [
    res("A Course in Arithmetic", "Jean-Pierre Serre", { type: "textbook" }),
  ],
});
