registerDetail({
  ...
  topics: [
    "Arithmetic functions & averages",
    "Dirichlet series & Euler products",
    "The Riemann zeta function",
    "Analytic continuation & the functional equation",
    "The prime number theorem",
    "Chebyshev estimates & Mertens' theorems",
    "Dirichlet characters",
    "Dirichlet L-functions",
    "Primes in arithmetic progressions",
    "Non-vanishing on Re(s) = 1",
    "Summation formulas (Abel, Euler–Maclaurin)",
    "The critical strip & zero-free regions",
    "Sieve methods",
    "The Riemann hypothesis (overview)",
  ],
  recommended: [
    res("Introduction to Analytic Number Theory", "Tom M. Apostol", { type: "textbook" }),
    res("Multiplicative Number Theory I: Classical Theory", "Montgomery & Vaughan", { type: "textbook" }),
  ],
  supplementary: [
    res("Multiplicative Number Theory", "Harold Davenport", { type: "textbook" }),
  ],
});
