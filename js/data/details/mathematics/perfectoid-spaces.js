registerDetail({
  ...
  topics: [
    ...
    "Huber rings & adic spaces",
    "Perfectoid fields",
    "Perfectoid algebras & spaces",
    ...
    "Diamonds",
    "Shimura varieties",
    "v-sheaves & small v-stacks",
    "Applications to the Langlands program",
  ],
  recommended: [
    res("Berkeley Lectures on p-adic Geometry", "Scholze & Weinstein", { type: "notes", free: true,
      url: "https://www.math.uni-bonn.de/people/scholze/Berkeley.pdf" }),
  ],
  supplementary: [
    res("Berkeley Lectures on p-adic Geometry", "Scholze & Weinstein", { type: "textbook" }),
  ],
});
