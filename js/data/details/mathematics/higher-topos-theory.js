registerDetail({
  ...
  topics: [
    ...
    "Sheaves of spaces",
    "Descent",
    "The ∞-categorical Giraud axioms",
    "Universality of colimits",
    "Groupoid objects & effectivity",
    "Truncation & Postnikov towers",
    "Hypercompletion",
    "Shape theory",
    "Étale homotopy type",
    ...
    "Localization",
    "n-topoi",
    "Applications to derived geometry",
  ],
  recommended: [
    res("Higher Topos Theory", "Jacob Lurie", { type: "textbook", free: true, url: "https://www.math.ias.edu/~lurie/papers/HTT.pdf" }),
  ],
  supplementary: [
