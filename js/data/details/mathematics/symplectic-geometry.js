registerDetail({
  ...
  topics: [
    ...
    "Compatible metrics & Kähler manifolds",
    "Pseudoholomorphic curves (intro)",
    "Gromov non-squeezing (overview)",
  ],
  recommended: [
    res("Lectures on Symplectic Geometry", "Ana Cannas da Silva", { type: "lectures", free: true, url: "https://people.math.ethz.ch/~acannas/Papers/lsg.pdf" }),
    res("Introduction to Symplectic Topology", "Dusa McDuff & Dietmar Salamon", { type: "textbook" }),
  ],
  supplementary: [
    res("Mathematical Methods of Classical Mechanics", "Vladimir Arnold", { type: "textbook" }),
  ],
});
