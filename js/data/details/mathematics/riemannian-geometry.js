registerDetail({
  ...
  topics: [
    ...
    "Completeness & Hopf–Rinow",
    "Comparison theorems",
    "Spaces of constant curvature",
  ],
  recommended: [
    res("Riemannian Geometry", "Manfredo do Carmo", { type: "textbook" }),
    res("Introduction to Riemannian Manifolds", "John M. Lee", { type: "textbook" }),
  ],
  supplementary: [
    res("Riemannian Geometry", "Peter Petersen", { type: "textbook" }),
  ],
});
