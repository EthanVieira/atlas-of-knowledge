registerDetail({
  ...
  topics: [
    ...
    "Strange attractors",
    "Fractals & the Lyapunov exponent",
    "Hyperbolicity",
    "Symbolic dynamics",
  ],
  recommended: [
    res("Nonlinear Dynamics and Chaos", "Steven Strogatz", { type: "textbook" }),
    res("Nonlinear Dynamics and Chaos (lectures)", "Steven Strogatz", { type: "video", free: true,
      url: "https://www.youtube.com/playlist?list=PLbN57C5Zdl6j_qJA-pARJnKsmROzPnO9V" }),
  ],
  supplementary: [
    res("Introduction to the Modern Theory of Dynamical Systems", "Katok & Hasselblatt", { type: "textbook" }),
  ],
});
