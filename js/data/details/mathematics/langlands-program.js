registerDetail({
  ...
  topics: [
    ...
    "The adelic reformulation",
    "Reductive groups & the Langlands dual",
    "Admissible representations of p-adic groups",
    "The local Langlands correspondence",
    "The global Langlands correspondence",
    "L-functions & ε-factors",
    "Functoriality",
    "Reciprocity",
    "Galois representations",
    "The Arthur–Selberg trace formula",
    "Endoscopy & stabilization",
    "Geometric Langlands (overview)",
  ],
  recommended: [
    res("Automorphic Forms and Representations", "Daniel Bump", { type: "textbook" }),
  ],
  supplementary: [
    res("An Introduction to the Langlands Program", "Bernstein & Gelbart (eds.)", { type: "textbook" }),
  ],
});
