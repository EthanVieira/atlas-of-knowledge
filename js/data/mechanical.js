...
registerCourses([
  ...
  { id: "fluid-mechanics-eng", title: "Fluid Mechanics (Engineering)", field: "mecheng", detail: true, requires: ["engineering-dynamics", "calculus-3"] },
  ...
  { id: "internal-combustion-engines", title: "Internal Combustion Engines", field: "mecheng", detail: true, requires: ["engineering-thermodynamics", "heat-transfer"] },
  { id: "hvac-refrigeration", title: "HVAC & Refrigeration", field: "mecheng", detail: true, requires: ["engineering-thermodynamics", "heat-transfer"] },

  // --- Dynamics, vibration & computation ---
  { id: "mechanical-vibrations", title: "Mechanical Vibrations", field: "mecheng", detail: true, requires: ["engineering-dynamics", "ode"] },
  ...
  { id: "automotive-engineering", title: "Automotive Engineering", field: "mecheng", detail: true, requires: ["engineering-dynamics", "internal-combustion-engines"] },
