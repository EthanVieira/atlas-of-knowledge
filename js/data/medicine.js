...
registerCourses([
  ...
  { id: "pathophysiology", title: "Systemic Pathology & Pathophysiology", field: "medicine", detail: true, requires: ["general-pathology", "medical-physiology"] },
  ...
  { id: "clinical-skills", title: "Clinical Medicine & Physical Diagnosis", field: "medicine", detail: true, requires: ["medical-physiology", "human-anatomy"] },
  ...
  // --- Diagnostics -------------------------------------------------------
  { id: "radiology", title: "Diagnostic Radiology & Imaging", field: "medicine", detail: true, requires: ["human-anatomy", "general-pathology"] },
  ...
  { id: "surgery", title: "Surgery", field: "medicine", detail: true, requires: ["human-anatomy", "clinical-skills", "pathophysiology"] },
  ...
  { id: "family-medicine", title: "Family Medicine & Primary Care", field: "medicine", detail: true, requires: ["internal-medicine", "pediatrics"] },
