...
registerCourses([
  ...
  { id: "databases", title: "Database Systems", field: "cs", detail: true, requires: ["algorithms"] },
  { id: "concurrency", title: "Concurrency & Parallelism", field: "cs", detail: true, requires: ["operating-systems"] },
  { id: "distributed-systems", title: "Distributed Systems", field: "cs", detail: true, requires: ["computer-networks"] },
  ...
  { id: "formal-verification", title: "Formal Verification", field: "cs", detail: true, requires: ["programming-language-theory"] },
  { id: "cryptography", title: "Cryptography", field: "cs", detail: true, requires: ["elementary-number-theory", "algorithms"] },
  { id: "computer-security", title: "Computer Security", field: "cs", detail: true, requires: ["computer-networks", "cryptography"] },
  ...
  { id: "digital-signal-processing", title: "Digital Signal Processing", field: "cs", detail: true, requires: ["fourier-analysis"] },
  ...
  { id: "computer-vision", title: "Computer Vision", field: "cs", detail: true, requires: ["deep-learning"] },
  { id: "natural-language-processing", title: "Natural Language Processing", field: "cs", detail: true, requires: ["deep-learning"] },
  { id: "probabilistic-graphical-models", title: "Probabilistic Graphical Models", field: "cs", detail: true, requires: ["machine-learning"] },
  { id: "statistical-learning-theory", title: "Statistical Learning Theory", field: "cs", detail: true, requires: ["machine-learning"] },
  ...
  { id: "robotics", title: "Robotics", field: "cs", detail: true, requires: ["machine-learning", "classical-mechanics"] },
