...
registerCourses([
  ...
  { id: "advanced-classical-mechanics", title: "Advanced Classical Mechanics", field: "physics", detail: true, requires: ["classical-mechanics"] },
  { id: "waves-oscillations", title: "Waves & Oscillations", field: "physics", detail: true, requires: ["classical-mechanics"] },
  { id: "thermodynamics", title: "Thermodynamics", field: "physics", detail: true, requires: ["classical-mechanics"] },
  ...
  { id: "continuum-mechanics", title: "Continuum Mechanics", field: "physics", detail: true, requires: ["classical-mechanics"] },
  { id: "fluid-dynamics", title: "Fluid Dynamics", field: "physics", detail: true, requires: ["continuum-mechanics", "pde"] },
  { id: "classical-electrodynamics", title: "Classical Electrodynamics", field: "physics", detail: true, requires: ["special-relativity", "pde"] },

  // --- Statistical & thermal ---
  { id: "statistical-mechanics", title: "Statistical Mechanics", field: "physics", detail: true, requires: ["probability", "thermodynamics"] },
  { id: "kinetic-theory", title: "Kinetic Theory", field: "physics", detail: true, requires: ["statistical-mechanics"] },
  ...
  // --- Quantum ---
  { id: "quantum-mechanics", title: "Quantum Mechanics", field: "physics", detail: true, requires: ["classical-mechanics"] },
  ...
  { id: "quantum-field-theory", title: "Quantum Field Theory", field: "physics", detail: true, requires: ["advanced-quantum-mechanics", "special-relativity"] },
  ...
  { id: "supersymmetry", title: "Supersymmetry", field: "physics", detail: true, requires: ["gauge-theory"] },
  { id: "string-theory", title: "String Theory", field: "physics", detail: true, requires: ["general-relativity", "conformal-field-theory"] },
  ...
  { id: "astrophysics", title: "Astrophysics", field: "physics", detail: true, requires: ["thermodynamics", "quantum-mechanics"] },
  ...
  { id: "ads-cft", title: "AdS/CFT & Holography", field: "physics", detail: true, requires: ["string-theory"] },
  ...
  { id: "quantum-information", title: "Quantum Information Science", field: "physics", detail: true, requires: ["quantum-mechanics"] },
  { id: "mathematical-methods-physics", title: "Mathematical Methods of Physics", field: "physics", detail: true, requires: ["general-physics", "linear-algebra"] },
]);
