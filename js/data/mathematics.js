...
registerCourses([
  ...
  { id: "precalculus", title: "Precalculus", field: "mathematics", detail: true, requires: ["elementary-algebra", "trigonometry"] },
  ...
  { id: "functional-analysis", title: "Functional Analysis", field: "mathematics", detail: true, requires: ["real-analysis", "linear-algebra", "point-set-topology"] },
  ...
  { id: "pde", title: "Partial Differential Equations", field: "mathematics", detail: true, requires: ["ode", "real-analysis", "functional-analysis"] },
  ...
  { id: "commutative-algebra", title: "Commutative Algebra", field: "mathematics", detail: true, requires: ["ring-theory", "field-theory"] },
  ...
  { id: "representation-theory", title: "Representation Theory", field: "mathematics", detail: true, requires: ["group-theory", "linear-algebra", "ring-theory"] },
  ...
  // --- Number theory ---
  { id: "elementary-number-theory", title: "Elementary Number Theory", field: "mathematics", detail: true, requires: ["discrete-math", "proof-writing"] },
  ...
  { id: "class-field-theory", title: "Class Field Theory", field: "mathematics", detail: true, requires: ["algebraic-number-theory", "galois-theory"] },
  { id: "modular-forms", title: "Modular Forms", field: "mathematics", detail: true, requires: ["complex-analysis", "elementary-number-theory"] },
  { id: "elliptic-curves", title: "Elliptic Curves", field: "mathematics", detail: true, requires: ["galois-theory", "algebraic-number-theory"] },
  ...
  { id: "sheaf-theory", title: "Sheaves & Cohomology", field: "mathematics", detail: true, requires: ["category-theory", "point-set-topology", "module-theory-adv"] },
  ...
  { id: "arithmetic-geometry", title: "Arithmetic Geometry", field: "mathematics", detail: true, requires: ["scheme-theory", "elliptic-curves", "etale-cohomology"] },
  ...
  { id: "axiomatic-set-theory", title: "Axiomatic Set Theory", field: "mathematics", detail: true, requires: ["set-theory", "mathematical-logic"] },
  ...
  { id: "derived-algebraic-geometry", title: "Derived Algebraic Geometry", field: "mathematics", detail: true, requires: ["scheme-theory", "infinity-categories", "module-theory-adv"] },
  ...
  { id: "perfectoid-spaces", title: "Perfectoid Spaces", field: "mathematics", detail: true, requires: ["arithmetic-geometry", "p-adic-analysis", "etale-cohomology"] },
  { id: "langlands-program", title: "The Langlands Program", field: "mathematics", detail: true, requires: ["class-field-theory", "representation-theory", "modular-forms", "etale-cohomology"] },
